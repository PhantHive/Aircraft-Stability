...
class LatAircraftMatrix(FlightData):
    ...
    def calculate_Yv(self, wing_area):
        first_part = (self.q_mean *
                      wing_area) / (self.cruise_conditions["m"]["value"] *
    ...
    def calculate_Yp(self, wing_area, wing_span):
        first_part = (self.q_mean * wing_area *
                      wing_span) / (2 * self.cruise_conditions["m"]["value"] *
                                    self.cruise_conditions["V"]["value"])
    ...
    def calculate_Lv(self, wing_area, wing_span):
        first_part = (self.q_mean * wing_area *
                      wing_span) / (self.cruise_conditions["Ixx"]["value"] *
                                    self.cruise_conditions["V"]["value"])
    ...
    def calculate_Lp(self, wing_area, wing_span):
        first_part = (self.q_mean * wing_area * wing_span**2) / (
            2 * self.cruise_conditions["Ixx"]["value"] *
            self.cruise_conditions["V"]["value"])
    ...
    def calculate_Nv(self, wing_area, wing_span):
        first_part = (self.q_mean * wing_area *
                      wing_span) / (self.cruise_conditions["Izz"]["value"] *
                                    self.cruise_conditions["V"]["value"])
    ...
    def calculate_Np(self, wing_area, wing_span):
        first_part = (self.q_mean * wing_area * wing_span**2) / (
            2 * self.cruise_conditions["Izz"]["value"] *
            self.cruise_conditions["V"]["value"])
    ...
    def set_lat_stability_aircraft_matrix(self):
        ...
        self.aircraft_matrix = np.array([
            [
                self.Yv,
                self.Yp,
                -(self.cruise_conditions["V"]["value"] - self.Yr),
                self.cruise_conditions["g"]["value"] * np.cos(
                    (np.pi * self.cruise_conditions["theta"]["value"] / 180)),
            ],
