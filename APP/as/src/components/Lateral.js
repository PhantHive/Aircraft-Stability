...
class Lateral extends Component {
  ...
  downloadResult = (data) => {
    ...
    // this.imgPhugoid =
    // dataToTxt.substring(dataToTxt.indexOf('ImageDataPhugoid<') + 17,
    // dataToTxt.indexOf('>Phugoid')); this.imgShort =
    // dataToTxt.substring(dataToTxt.indexOf('ImageDataShort<') + 15,
    // dataToTxt.indexOf('>Short')); console.log(this.imgPhugoid);
