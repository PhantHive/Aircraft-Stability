...
class Lateral extends Component {
  ...
  downloadResult = (data) => {
    ...
    this.imgRolling = dataToTxt.substring(
      dataToTxt.indexOf("ImageDataRolling<") + 17,
      dataToTxt.indexOf(">Rolling")
    );
    this.imgSpiral = dataToTxt.substring(
      dataToTxt.indexOf("ImageDataSpiral<") + 16,
      ...
      reader2.onload = () => {
        ...
        fetch("http://localhost:3001/process_data", {
          ...
          .then((data) => {
            ...
            document
              .getElementsByClassName("lateral-file-selector")[0]
              .remove();
            document
              .getElementsByClassName("lateral-calculation-button")[0]
              .remove();
  ...
  render() {
    return (
      <div className="lateral-container">
        ...
        <img
          className="lateral-image"
          src={require("../assets/images/plane-lateral.png")}
          alt="lateral stability"
        />
        <h2 className="select">
        ...
        {this.state.calculationComplete && (
          <div className="lateral-calculation-result">
            ...
            <button
              ...
              className="lateral-download-button"
            >
              Download data
            </button>
          </div>
        ...
        {this.state.calculationComplete && (
          <div className="reset">
            ...
            <div className="plot-images">
              <img
                src={`data:image/png;base64,${this.imgRolling}`}
                alt="Rolling Mode Response"
                className="rolling-curve"
              />
              <img
                src={`data:image/png;base64,${this.imgSpiral}`}
                alt="Spiral Mode Response"
                className="spiral-curve"
              />
            </div>
          </div>
        )}
